...
.. py:class:: Connect4Analysis(/, **data: Any)
   ...
   .. autolink-examples:: Connect4Analysis
      :collapse:
   ...
   .. py:method:: _default_threats() -> dict[str, list[int]]
      ...
      .. autolink-examples:: _default_threats
         :collapse:
   ...
   .. py:method:: validate_center_control(v: int) -> int
      ...
      .. autolink-examples:: validate_center_control
         :collapse:
   ...
   .. py:method:: validate_winning_chances(v: int) -> int
      ...
      .. autolink-examples:: validate_winning_chances
         :collapse:
...
.. py:class:: Connect4Move(/, **data: Any)
   ...
   .. autolink-examples:: Connect4Move
      :collapse:
   ...
   .. py:method:: validate_column(v: int) -> int
      ...
      .. autolink-examples:: validate_column
         :collapse:
...
.. py:class:: Connect4PlayerDecision(/, **data: Any)
   ...
   .. autolink-examples:: Connect4PlayerDecision
      :collapse:

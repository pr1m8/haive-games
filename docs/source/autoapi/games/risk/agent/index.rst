...
.. toggle:: Show Inheritance Diagram
   ...
   Inheritance diagram for RiskAgent:

   .. graphviz::
      :align: center

      digraph inheritance_RiskAgent {
        node [shape=record];
        "RiskAgent" [label="RiskAgent"];
        "pydantic.BaseModel" -> "RiskAgent";
      }

.. autopydantic_model:: games.risk.agent.RiskAgent
   :members:
   :undoc-members:
   :show-inheritance:

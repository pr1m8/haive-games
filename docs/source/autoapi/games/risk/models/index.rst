...
.. py:class:: Continent(/, **data: Any)
   ...
   .. py:method:: validate_territories(v: list[str]) -> list[str]
      ...
      .. autolink-examples:: validate_territories
         :collapse:
   ...
   .. py:property:: bonus_per_territory
      ...
      .. autolink-examples:: bonus_per_territory
         :collapse:
   ...
   .. py:property:: territory_count
      ...
      .. autolink-examples:: territory_count
         :collapse:
...
.. py:class:: Player(/, **data: Any)
   ...
   .. py:method:: validate_unplaced_armies(v: int) -> int
      ...
      .. autolink-examples:: validate_unplaced_armies
         :collapse:
   ...
   .. py:property:: can_trade_cards
      ...
      .. autolink-examples:: can_trade_cards
         :collapse:
   ...
   .. py:property:: must_trade_cards
      ...
      .. autolink-examples:: must_trade_cards
         :collapse:
...
.. py:class:: RiskAnalysis(/, **data: Any)
   ...
   .. autolink-examples:: RiskAnalysis
      :collapse:
   ...
   .. py:method:: validate_position_evaluation(v: str) -> str
      ...
      .. autolink-examples:: validate_position_evaluation
         :collapse:
   ...
   .. py:property:: average_armies_per_territory
      ...
      .. autolink-examples:: average_armies_per_territory
         :collapse:
   ...
   .. py:property:: continent_bonus
      ...
      .. autolink-examples:: continent_bonus
         :collapse:
...
.. py:class:: RiskMove(/, **data: Any)
   ...
   .. py:method:: validate_armies(v: int | None) -> int | None
      ...
      .. autolink-examples:: validate_armies
         :collapse:
   ...
   .. py:method:: validate_attack_dice(v: int | None) -> int | None
      ...
      .. autolink-examples:: validate_attack_dice
         :collapse:
   ...
   .. py:property:: is_aggressive
      ...
      .. autolink-examples:: is_aggressive
         :collapse:
...
.. py:class:: Territory(/, **data: Any)
   ...
   .. py:method:: validate_name(v: str) -> str
      ...
      .. autolink-examples:: validate_name
         :collapse:
   ...
   .. py:property:: defense_strength
      ...
      .. autolink-examples:: defense_strength
         :collapse:

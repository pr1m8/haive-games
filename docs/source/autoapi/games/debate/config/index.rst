...
.. toggle:: Show Inheritance Diagram
   ...
   Inheritance diagram for DebateAgentConfig:

   .. graphviz::
      :align: center

      digraph inheritance_DebateAgentConfig {
        node [shape=record];
        "DebateAgentConfig" [label="DebateAgentConfig"];
        "haive.core.engine.agent.agent.AgentConfig" -> "DebateAgentConfig";
      }

.. autoclass:: games.debate.config.DebateAgentConfig
   :members:
   :undoc-members:
   :show-inheritance:

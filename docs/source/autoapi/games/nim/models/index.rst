...
.. py:class:: NimAnalysis(/, **data: Any)
   ...
   .. py:property:: analysis_confidence
      ...
      .. autolink-examples:: analysis_confidence
         :collapse:
   ...
   .. py:property:: is_winning_position
      ...
      .. autolink-examples:: is_winning_position
         :collapse:
   ...
   .. py:property:: strategic_summary
      ...
      .. autolink-examples:: strategic_summary
         :collapse:
...
.. py:class:: NimMove(/, **data: Any)
   ...
   .. py:method:: validate_alternative_moves(v: list[dict[str, int]]) -> list[dict[str, int]]
      ...
      .. autolink-examples:: validate_alternative_moves
         :collapse:
   ...
   .. py:property:: has_strategic_context
      ...
      .. autolink-examples:: has_strategic_context
         :collapse:
   ...
   .. py:property:: move_notation
      ...
      .. autolink-examples:: move_notation
         :collapse:
...
.. py:class:: PositionType
   ...
   .. autolink-examples:: PositionType
      :collapse:

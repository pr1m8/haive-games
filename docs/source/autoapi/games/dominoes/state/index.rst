...
.. toggle:: Show Inheritance Diagram
   ...
   Inheritance diagram for DominoesState:

   .. graphviz::
      :align: center

      digraph inheritance_DominoesState {
        node [shape=record];
        "DominoesState" [label="DominoesState"];
        "haive.games.framework.base.state.GameState" -> "DominoesState";
      }

.. autoclass:: games.dominoes.state.DominoesState
   :members:
   :undoc-members:
   :show-inheritance:

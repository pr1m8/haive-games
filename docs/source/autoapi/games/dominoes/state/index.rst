...
.. autoapi-nested-parse::
   ...
   .. autolink-examples:: games.dominoes.state
      :collapse:
...
.. py:class:: DominoesState
   ...
   .. autolink-examples:: DominoesState
      :collapse:
   ...
   .. py:method:: get_playable_tiles(player: str) -> list[haive.games.dominoes.models.DominoTile]
      ...
      .. autolink-examples:: get_playable_tiles
         :collapse:
   ...
   .. py:property:: boneyard_size
      ...
      .. autolink-examples:: boneyard_size
         :collapse:
   ...
   .. py:property:: total_tiles_in_play
      ...
      .. autolink-examples:: total_tiles_in_play
         :collapse:

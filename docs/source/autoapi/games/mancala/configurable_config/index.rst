...
:py:mod:`games.mancala.configurable_config`
===========================================
...
.. autolink-examples:: games.mancala.configurable_config
   :collapse:
...
.. toggle:: Show Inheritance Diagram
   ...
   Inheritance diagram for ConfigurableMancalaConfig:

   .. graphviz::
      :align: center

      digraph inheritance_ConfigurableMancalaConfig {
        node [shape=record];
        "ConfigurableMancalaConfig" [label="ConfigurableMancalaConfig"];
        "haive.games.mancala.config.MancalaConfig" -> "ConfigurableMancalaConfig";
      }

.. autoclass:: games.mancala.configurable_config.ConfigurableMancalaConfig
   :members:
   :undoc-members:
   :show-inheritance:
...
.. py:function:: create_advanced_mancala_config(**kwargs) -> ConfigurableMancalaConfig
   ...
   .. autolink-examples:: create_advanced_mancala_config
      :collapse:
...
.. py:function:: create_budget_mancala_config(**kwargs) -> ConfigurableMancalaConfig
   ...
   .. autolink-examples:: create_budget_mancala_config
      :collapse:
...
.. py:function:: create_experimental_mancala_config(**kwargs) -> ConfigurableMancalaConfig
   ...
   .. autolink-examples:: create_experimental_mancala_config
      :collapse:
...
.. py:function:: create_mancala_config(player1_model: str = 'gpt-4o', player2_model: str = 'claude-3-5-sonnet-20240620', **kwargs) -> ConfigurableMancalaConfig
   ...
   .. autolink-examples:: create_mancala_config
      :collapse:
...
.. py:function:: create_mancala_config_from_example(example_name: str, **kwargs) -> ConfigurableMancalaConfig
   ...
   .. autolink-examples:: create_mancala_config_from_example
      :collapse:
...
.. py:function:: create_mancala_config_from_player_configs(player_configs: dict[str, haive.games.core.agent.player_agent.PlayerAgentConfig], **kwargs) -> ConfigurableMancalaConfig
   ...
   .. autolink-examples:: create_mancala_config_from_player_configs
      :collapse:

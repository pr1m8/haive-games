...
.. toggle:: Show Inheritance Diagram
   ...
   Inheritance diagram for MancalaAnalysis:

   .. graphviz::
      :align: center

      digraph inheritance_MancalaAnalysis {
        node [shape=record];
        "MancalaAnalysis" [label="MancalaAnalysis"];
        "pydantic.BaseModel" -> "MancalaAnalysis";
      }

.. autopydantic_model:: games.mancala.models.MancalaAnalysis
   :members:
   :undoc-members:
   :show-inheritance:
...
.. toggle:: Show Inheritance Diagram
   ...
   Inheritance diagram for MancalaMove:

   .. graphviz::
      :align: center

      digraph inheritance_MancalaMove {
        node [shape=record];
        "MancalaMove" [label="MancalaMove"];
        "pydantic.BaseModel" -> "MancalaMove";
      }

.. autopydantic_model:: games.mancala.models.MancalaMove
   :members:
   :undoc-members:
   :show-inheritance:
   :model-show-field-summary:

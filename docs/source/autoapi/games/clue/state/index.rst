...
.. toggle:: Show Inheritance Diagram
   ...
   Inheritance diagram for ClueState:

   .. graphviz::
      :align: center

      digraph inheritance_ClueState {
        node [shape=record];
        "ClueState" [label="ClueState"];
        "haive.games.framework.base.state.GameState" -> "ClueState";
      }

.. autoclass:: games.clue.state.ClueState
   :members:
   :undoc-members:
   :show-inheritance:

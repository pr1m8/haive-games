...
.. py:class:: ClueCard
   ...
   .. py:method:: from_suspect(suspect: ValidSuspect) -> ClueCard
      ...
      .. autolink-examples:: from_suspect
         :collapse:
...
.. py:class:: ClueHypothesis
   ...
   .. autolink-examples:: ClueHypothesis
      :collapse:
...
.. py:class:: ClueResponse
   ...
   .. autolink-examples:: ClueResponse
      :collapse:
...
.. py:class:: ClueSolution
   ...
   .. autolink-examples:: ClueSolution
      :collapse:
...
.. py:class:: ValidSuspect(*args, **kwds)
   ...
   .. autolink-examples:: ValidSuspect
      :collapse:

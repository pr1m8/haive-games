...
:py:mod:`games.fox_and_geese.state`
===================================
...
.. toggle:: Show Inheritance Diagram
   ...
   Inheritance diagram for FoxAndGeeseState:

   .. graphviz::
      :align: center

      digraph inheritance_FoxAndGeeseState {
        node [shape=record];
        "FoxAndGeeseState" [label="FoxAndGeeseState"];
        "haive.games.framework.base.state.GameState" -> "FoxAndGeeseState";
      }

.. autoclass:: games.fox_and_geese.state.FoxAndGeeseState
   :members:
   :undoc-members:
   :show-inheritance:

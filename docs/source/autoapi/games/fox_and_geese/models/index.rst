...
:py:mod:`games.fox_and_geese.models`
====================================
...
.. toggle:: Show Inheritance Diagram
   ...
   Inheritance diagram for FoxAndGeeseAnalysis:

   .. graphviz::
      :align: center

      digraph inheritance_FoxAndGeeseAnalysis {
        node [shape=record];
        "FoxAndGeeseAnalysis" [label="FoxAndGeeseAnalysis"];
        "pydantic.BaseModel" -> "FoxAndGeeseAnalysis";
      }

.. autopydantic_model:: games.fox_and_geese.models.FoxAndGeeseAnalysis
   :members:
   :undoc-members:
   :show-inheritance:
...
.. toggle:: Show Inheritance Diagram
   ...
   Inheritance diagram for FoxAndGeeseMove:

   .. graphviz::
      :align: center

      digraph inheritance_FoxAndGeeseMove {
        node [shape=record];
        "FoxAndGeeseMove" [label="FoxAndGeeseMove"];
        "pydantic.BaseModel" -> "FoxAndGeeseMove";
      }

.. autopydantic_model:: games.fox_and_geese.models.FoxAndGeeseMove
   :members:
   :undoc-members:
   :show-inheritance:
   :model-show-field-summary:
...
.. toggle:: Show Inheritance Diagram
   ...
   Inheritance diagram for FoxAndGeesePosition:

   .. graphviz::
      :align: center

      digraph inheritance_FoxAndGeesePosition {
        node [shape=record];
        "FoxAndGeesePosition" [label="FoxAndGeesePosition"];
        "pydantic.BaseModel" -> "FoxAndGeesePosition";
      }

.. autopydantic_model:: games.fox_and_geese.models.FoxAndGeesePosition
   :members:
   :undoc-members:
   :show-inheritance:
   :model-show-field-summary:

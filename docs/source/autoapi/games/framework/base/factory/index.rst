...
.. py:class:: GameAgentFactory
            ...
            .. py:method:: create_game_agent(name: str, state_schema: type[haive.games.framework.base.state.GameState], state_manager: type[haive.games.framework.base.state_manager.GameStateManager], player1_name: str = 'player1', player2_name: str = 'player2', enable_analysis: bool = True, aug_llm_configs: dict[str, haive.core.engine.aug_llm.AugLLMConfig] | None = None, custom_nodes: dict[str, collections.abc.Callable] | None = None, custom_edges: list[dict[str, Any]] | None = None, conditional_edges: dict[str, dict[str, Any]] | None = None) -> type[haive.core.engine.agent.agent.Agent]
               :staticmethod:
...
.. admonition:: Quick Reference
   ...
   .. code-block:: python
      ...
      from games.framework.base.factory import *

...
:py:mod:`games.framework.multi_player.state`
============================================
...
.. autolink-examples:: games.framework.multi_player.state
   :collapse:
...
.. autopydantic_model:: games.framework.multi_player.state.MultiPlayerGameState
   :members:
   :undoc-members:
   :show-inheritance:

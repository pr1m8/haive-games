...
:py:mod:`games.mastermind.configurable_config`
==============================================
...
.. autolink-examples:: games.mastermind.configurable_config
   :collapse:
...
.. toggle:: Show Inheritance Diagram
   ...
   Inheritance diagram for ConfigurableMastermindConfig:

   .. graphviz::
      :align: center

      digraph inheritance_ConfigurableMastermindConfig {
        node [shape=record];
        "ConfigurableMastermindConfig" [label="ConfigurableMastermindConfig"];
        "haive.games.mastermind.config.MastermindConfig" -> "ConfigurableMastermindConfig";
      }

.. autoclass:: games.mastermind.configurable_config.ConfigurableMastermindConfig
   :members:
   :undoc-members:
   :show-inheritance:
...
.. py:function:: create_advanced_mastermind_config(**kwargs) -> ConfigurableMastermindConfig
   ...
   .. autolink-examples:: create_advanced_mastermind_config
      :collapse:
...
.. py:function:: create_budget_mastermind_config(**kwargs) -> ConfigurableMastermindConfig
   ...
   .. autolink-examples:: create_budget_mastermind_config
      :collapse:
...
.. py:function:: create_experimental_mastermind_config(**kwargs) -> ConfigurableMastermindConfig
   ...
   .. autolink-examples:: create_experimental_mastermind_config
      :collapse:
...
.. py:function:: create_mastermind_config(codemaker_model: str = 'gpt-4o', codebreaker_model: str = 'claude-3-5-sonnet-20240620', **kwargs) -> ConfigurableMastermindConfig
   ...
   .. autolink-examples:: create_mastermind_config
      :collapse:
...
.. py:function:: create_mastermind_config_from_example(example_name: str, **kwargs) -> ConfigurableMastermindConfig
   ...
   .. autolink-examples:: create_mastermind_config_from_example
      :collapse:
...
.. py:function:: create_mastermind_config_from_player_configs(player_configs: dict[str, haive.games.core.agent.player_agent.PlayerAgentConfig], **kwargs) -> ConfigurableMastermindConfig
   ...
   .. autolink-examples:: create_mastermind_config_from_player_configs
      :collapse:

...
.. py:class:: ColorCode(/, **data: Any)
   ...
   .. attribute:: code
      ...
      List of exactly 4 colors from the valid color set.
   ...
   .. py:attribute:: code
      :type:  list[ValidColor]
      :value: None



.. py:class:: MastermindAnalysis(/, **data: Any)
   ...
   .. autolink-examples:: MastermindAnalysis
      :collapse:
   ...
   .. py:attribute:: eliminated_colors
      :type:  list[ValidColor]
      :value: None



   .. py:attribute:: fixed_positions
      :type:  list[dict[str, ValidColor]]
      :value: None



   .. py:attribute:: high_probability_colors
      :type:  list[ValidColor]
      :value: None



   .. py:attribute:: possible_combinations
      :type:  int
      :value: None
...
.. py:class:: MastermindFeedback(/, **data: Any)
   ...
   .. attribute:: correct_position

      Number of pegs with correct color and position (0-4).
      These are traditionally represented by black pegs.

   .. attribute:: correct_color

      Number of pegs with correct color but wrong position (0-4).
   ...
   .. autolink-examples:: MastermindFeedback
      :collapse:
   ...
   .. py:method:: __str__() -> str
      ...
      :returns: Human-readable feedback with emoji indicators.
      :rtype: str
...
.. py:class:: MastermindGuess(/, **data: Any)
   ...
   .. attribute:: colors
      ...
      List of exactly 4 colors representing the guess.
      Each position corresponds to a position in the secret code.

   .. attribute:: player

      Identifier for the player making this guess.
   ...
   .. autolink-examples:: MastermindGuess
      :collapse:
   ...
   .. py:method:: __str__() -> str
      ...
      :returns: Human-readable guess description.
      :rtype: str

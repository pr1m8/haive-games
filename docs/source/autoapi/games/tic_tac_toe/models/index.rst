...
.. py:class:: TicTacToeAnalysis(/, **data: Any)
   ...
   .. autolink-examples:: TicTacToeAnalysis
      :collapse:
   ...
   .. py:method:: validate_move_coordinates(v: list[dict[str, int]]) -> list[dict[str, int]]
      ...
      .. autolink-examples:: validate_move_coordinates
         :collapse:
   ...
   .. py:property:: has_immediate_threat
      ...
      .. autolink-examples:: has_immediate_threat
         :collapse:
   ...
   .. py:property:: threat_level
      ...
      .. autolink-examples:: threat_level
         :collapse:
...
.. py:class:: TicTacToeMove(/, **data: Any)
   ...
   .. autolink-examples:: TicTacToeMove
      :collapse:
   ...
   .. py:property:: board_position
      ...
      .. autolink-examples:: board_position
         :collapse:

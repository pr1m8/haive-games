...
:py:mod:`games.tic_tac_toe.state_manager`
=========================================
...
.. toggle:: Show Inheritance Diagram
   ...
   Inheritance diagram for TicTacToeStateManager:

   .. graphviz::
      :align: center

      digraph inheritance_TicTacToeStateManager {
        node [shape=record];
        "TicTacToeStateManager" [label="TicTacToeStateManager"];
        "haive.games.framework.base.state_manager.GameStateManager[haive.games.tic_tac_toe.state.TicTacToeState]" -> "TicTacToeStateManager";
      }

.. autoclass:: games.tic_tac_toe.state_manager.TicTacToeStateManager
   :members:
   :undoc-members:
   :show-inheritance:

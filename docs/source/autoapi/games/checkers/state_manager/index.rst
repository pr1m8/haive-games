...
:py:mod:`games.checkers.state_manager`
======================================
...
.. toggle:: Show Inheritance Diagram
   ...
   Inheritance diagram for CheckersStateManager:

   .. graphviz::
      :align: center

      digraph inheritance_CheckersStateManager {
        node [shape=record];
        "CheckersStateManager" [label="CheckersStateManager"];
      }

.. autoclass:: games.checkers.state_manager.CheckersStateManager
   :members:
   :undoc-members:
   :show-inheritance:

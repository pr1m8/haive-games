...
from haive.games.debate.models import Statement, Topic
...
def create_generic_debate_engines_simple(
    debater1_model: str, debater2_model: str, temperature: float = 0.3
) -> dict[str, AugLLMConfig]:
    ...
    return create_engines_from_simple_configs(
        debate_factory, debater1_model, debater2_model, temperature
    )

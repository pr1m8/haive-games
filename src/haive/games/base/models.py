...
class Board(BaseModel):
    ...
    grid: list[list[str]] | None = Field(None, description="Optional grid representation")

class Cell(BaseModel):
    """Represents a cell on the board."""
    row: int = Field(..., description="The row of the cell.")
    col: int = Field(..., description="The column of the cell.")
    content: str | None = Field(None, description="The content of the cell.")
...
class GameState(BaseModel):
    ...
    game_result: str | None = Field(None, description="The result of the game.")

...
class PlayerClaimAction(BaseModel):
    ...
    reasoning: str | None = Field(default=None, description="Reasoning behind the claim")
...
class ChallengeAction(BaseModel):
    ...
    reasoning: str | None = Field(default=None, description="Reasoning behind the challenge")

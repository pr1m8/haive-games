...
def _execute_decision(agent: MonopolyAgent, decision: dict[str, Any], functions_module) -> Any:
    ...
    try:
        ...
        if move_action:
            ...
            if action_type == "roll_for_double" and hasattr(functions_module, "roll"):
        ...
        if property_actions:
            ...
            if action_type == "build" and hasattr(functions_module, "build"):
                return functions_module.build()

            if action_type == "sell" and hasattr(functions_module, "sellhouse"):
                return functions_module.sellhouse()

            if action_type == "mortgage" and hasattr(functions_module, "mortgage"):
                return functions_module.mortgage()

            if action_type == "unmortgage" and hasattr(functions_module, "unmortgage"):

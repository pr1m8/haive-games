...
class MonopolyAgentConfig(AgentConfig):
    ...
    def create_multi_model(
        ...
        max_history: int = 5,
        num_players: int = 2,
        primary_engine: EngineConfig | None = None,
        strategy_engine: EngineConfig | None = None,
        move_engine: EngineConfig | None = None,
        property_engine: EngineConfig | None = None,
        turn_engine: EngineConfig | None = None,
        **kwargs
    ) -> "MonopolyAgentConfig":

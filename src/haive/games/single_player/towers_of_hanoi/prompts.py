...
# Analysis prompt - focused on understanding the game state
HANOI_ANALYSIS_SYSTEM_PROMPT = """You are an expert Tower of Hanoi solver providing in-depth analysis.
...
HANOI_ANALYSIS_HUMAN_PROMPT = """# Current State
{state}
...
analysis_prompt_template = ChatPromptTemplate.from_messages(
    [
        SystemMessagePromptTemplate.from_template(HANOI_ANALYSIS_SYSTEM_PROMPT),
        HumanMessagePromptTemplate.from_template(HANOI_ANALYSIS_HUMAN_PROMPT),
    ]
)

# Move selection prompt - uses structured output for move decision
HANOI_MOVE_SYSTEM_PROMPT = """You are an expert Tower of Hanoi player who must select the optimal move.
...
HANOI_MOVE_HUMAN_PROMPT = """# Current State
{state}
...
move_prompt_template = ChatPromptTemplate.from_messages(
    [
        SystemMessagePromptTemplate.from_template(HANOI_MOVE_SYSTEM_PROMPT),
        HumanMessagePromptTemplate.from_template(HANOI_MOVE_HUMAN_PROMPT),
    ]
)

...
#from haive_games.framework.multi_player.factory import MultiPlayerGameFactory
from haive_core.engine.aug_llm import AugLLMConfig
from haive_core.models.llm.base import AzureLLMConfig
from langchain_core.prompts import ChatPromptTemplate, MessagesPlaceholder
from langchain_core.messages import SystemMessage

from haive_games.among_us.agent import AmongUsAgent
from haive_games.among_us.state import AmongUsState
from haive_games.among_us.models import PlayerRole, AmongUsGamePhase
from haive_games.among_us.prompts import CREWMATE_PROMPT, IMPOSTOR_PROMPT, MEETING_PROMPT, VOTING_PROMPT
...
def create_among_us_game(
    ...
    emergency_meetings_per_player=final_game_config["emergency_meetings_per_player"],

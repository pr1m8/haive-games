...
Example:
    >>> from haive_games.chess.aug_llms import aug_llm_configs
    >>> 
...
from haive_core.models.llm.base import AzureLLMConfig, DeepSeekLLMConfig, LLMConfig
...
def build_chess_aug_llms_per_color(
    *,
    white_llm: Optional[LLMConfig] = AzureLLMConfig(),
    black_llm: Optional[LLMConfig] = DeepSeekLLMConfig(),

...
from haive_games.clue.models import (
    ClueSolution, ClueGuess, ClueResponse, ClueHypothesis,
    ValidSuspect, ValidWeapon, ValidRoom, 
    ClueCard, GameStatus
)
from haive_games.clue.engines import clue_engines
from haive_core.engine.aug_llm import AugLLMEngine
...
class CluePlayer:
    ...
    player_engine: Optional[AugLLMEngine] = None
    analysis_engine: Optional[AugLLMEngine] = None

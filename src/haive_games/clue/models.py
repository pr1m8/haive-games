...
class ClueResponse:
    ...
    responding_player: Optional[str] = None  # Name of the player who responded (if any)
    refuting_card: Optional[ClueCard] = None  # The card shown to refute the guess (if any)
...
class ClueHypothesis:
    ...
    # Primary suspects
    prime_suspect: Optional[ValidSuspect] = None
    prime_weapon: Optional[ValidWeapon] = None
    prime_room: Optional[ValidRoom] = None
